...
<nav class="small-3 medium-2 large-2 columns" id="actions-sidebar">
    <ul class="menu vertical">
        ...
        <li><?= $this->Html->link(__('Edit Asram'), ['action' => 'edit', $asram->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Asram'), ['action' => 'delete', $asram->id], ['confirm' => __('Are you sure you want to delete # {0}?', $asram->id)]) ?> </li>
        <li><?= $this->Html->link(__('List Asrams'), ['action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New Asram'), ['action' => 'add']) ?> </li>
...
<div class="asrams view small-9 medium-10 large-10 columns content">
    <h3><?= h($asram->name) ?></h3>
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= $this->Number->format($asram->id) ?></td>
        </tr>
    </table>
    <div class="related">
        <h4><?= __('Related Bhaktas') ?></h4>
        <?php if (!empty($asram->bhaktas)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($asram->bhaktas as $bhaktas): ?>
            <tr>
                <td><?= h($bhaktas->id) ?></td>
