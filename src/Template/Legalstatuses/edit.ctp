...
<nav class="small-3 medium-2 large-2 columns" id="actions-sidebar">
    <ul class="menu vertical">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $legalstatus->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $legalstatus->id)]
            )
        ?></li>
...
<div class="legalstatuses form small-9 medium-10 large-10 columns content">
    <?= $this->Form->create($legalstatus) ?>
    <fieldset>
        <legend><?= __('Edit Legalstatus') ?></legend>
        <?php
