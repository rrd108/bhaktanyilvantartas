...
<nav class="small-3 medium-2 large-2 columns" id="actions-sidebar">
    <ul class="menu vertical">
        ...
        <li><?= $this->Html->link(__('Edit Communityrole'), ['action' => 'edit', $communityrole->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Communityrole'), ['action' => 'delete', $communityrole->id], ['confirm' => __('Are you sure you want to delete # {0}?', $communityrole->id)]) ?> </li>
        <li><?= $this->Html->link(__('List Communityroles'), ['action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New Communityrole'), ['action' => 'add']) ?> </li>
...
<div class="communityroles view small-9 medium-10 large-10 columns content">
    <h3><?= h($communityrole->name) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($communityrole->bhaktas)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($communityrole->bhaktas as $bhaktas): ?>
            <tr>
                <td><?= h($bhaktas->id) ?></td>
