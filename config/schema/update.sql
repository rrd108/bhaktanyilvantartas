...
CREATE TABLE IF NOT EXISTS `centers_users` (
  `id` SMALLINT(5) UNSIGNED NOT NULL AUTO_INCREMENT,
...
ALTER TABLE `departments` CHANGE COLUMN `aktiv` `active` TINYINT(1) NOT NULL;
ALTER TABLE `bhaktas` CHANGE COLUMN `aktiv` `active` TINYINT(1) NOT NULL DEFAULT '1' ;
